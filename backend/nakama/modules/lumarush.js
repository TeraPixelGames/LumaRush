var DEFAULT_LEADERBOARD_ID_OPEN = "lumarush_open_high_scores";
var DEFAULT_LEADERBOARD_ID_PURE = "lumarush_pure_high_scores";
...
function InitModule(ctx, logger, nk, initializer) {
  ...
  logger.info(
    "LumaRush Nakama module loaded. Leaderboards open=%s pure=%s",
...
function loadConfig(ctx) {
  ...
  return {
    leaderboardIds: {
      open:
        env.LUMARUSH_LEADERBOARD_ID_OPEN ||
        env.LUMARUSH_LEADERBOARD_ID ||
        DEFAULT_LEADERBOARD_ID_OPEN,
      pure:
        env.LUMARUSH_LEADERBOARD_ID_PURE ||
...
function ensureLeaderboard(nk, logger, leaderboardIds) {
  ensureLeaderboardOne(
    ...
    { game: "LumaRush", platform: "terapixel", mode: "open" }
  );
  ensureLeaderboardOne(
    nk,
    logger,
    String(leaderboardIds.pure || "").trim(),
    { game: "LumaRush", platform: "terapixel", mode: "pure" }
  );
}
