...
const COIN_PACKS := [
	{"product_id": "coins_500_lumarush", "label": "500 - $0.99"},
	{"product_id": "coins_1200_lumarush", "label": "1200 - $1.99"},
	{"product_id": "coins_3000_lumarush", "label": "3000 - $4.99"},
	{"product_id": "coins_7500_lumarush", "label": "7500 - $9.99"},
	{"product_id": "coins_20000_lumarush", "label": "20000 - $19.99"},
]
...
func _on_buy_hint_pressed() -> void:
